...
```bash
git clone https://github.com/CyberstepsDE/hacktank-0825-llmantis.git /opt/llmantis
cd /opt/llmantis
```
...
`deploy/Caddyfile` — but do it only after GRC has filled both pages.
