...
#     Datenschutz…". Backend opened it by hand: the bot DOES say it is AI, several
...
async def check(url: str, *, authorized: bool = False, exhaustive: bool = True,
    ...
    allow_private
                 ...
                 .env already sets it true for Attacks's lab, so a deploy carrying
            ...
            if not fired:
                ...
                if open_widget and greeting["read"] and not hit:
                    ...
                    if rep.opened_widget:
                        ...
                        #     Datenschutz…". Backend opened it by hand: o2's bot DOES
