...
WHAT IT PRODUCES
    The one number this whole role exists for (TARGET-LAB.md:16):
    ...
    section 5 UWG problem (TARGET-LAB.md:131).
...
def bot_context(bot_file: str) -> tuple[str, str, list[str]]:
    ...
    the canary belongs in one place (TARGET-LAB.md:145), and a copy in a
...
def report(results: list[dict], show_disagreements: bool) -> int:
    """Print the block from TARGET-LAB.md:120-129. Returns an exit code."""
