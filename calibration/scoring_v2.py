...
DEDUPLICATION - BUILT, OFF BY DEFAULT, DEFERRED TO PRODUCTION
    ...
    share a `fix`. Attacks's call (17.08) is that this is a production concern,
...
# Attacks's bands, 17.08. Six of them: adopting these introduced a grade E,
...
# Attacks's rule: "even 1 critical finding should prevent an A".
#
