...
WHY THIS EXISTS
    ...
    adapter in between - and nothing more. Per TARGET-LAB.md:22 the
...
WHY THE SYSTEM PROMPT LIVES HERE AND NOT ON AZURE
    ...
    fix, and the demo's closing beat (TARGET-LAB.md:60) would be a lie.
...
def build_app(bot: Bot) -> FastAPI:
    ...
    def health():
        ...
        TARGET-LAB.md:146 the canary is never printed in logs or report
